...
@AutoSpellConfig
public class ArchmageLightningBoltSpell extends LightningBoltSpell {
    ...
    public ArchmageLightningBoltSpell() {
    ...
    public ResourceLocation getSpellResource() {
        return ResourceLocation.fromNamespaceAndPath(mooStack.MODID, "archmage_lightning_bolt");
    }
}
