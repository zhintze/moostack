...
@AutoSpellConfig
public class ArchmageWololoSpell extends WololoSpell {
    ...
    public ResourceLocation getSpellResource() {
        return ResourceLocation.fromNamespaceAndPath(mooStack.MODID, "archmage_wololo");
    }
}
