...
@AutoSpellConfig
public class ArchmageIceTombSpell extends IceTombSpell {
    ...
    public ResourceLocation getSpellResource() {
        return ResourceLocation.fromNamespaceAndPath(mooStack.MODID, "archmage_ice_tomb");
    }
}
