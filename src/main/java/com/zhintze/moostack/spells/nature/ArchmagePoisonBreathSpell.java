...
@AutoSpellConfig
public class ArchmagePoisonBreathSpell extends PoisonBreathSpell {
    ...
    public ArchmagePoisonBreathSpell() {
    ...
    public ResourceLocation getSpellResource() {
        return ResourceLocation.fromNamespaceAndPath(mooStack.MODID, "archmage_poison_breath");
    }
}
