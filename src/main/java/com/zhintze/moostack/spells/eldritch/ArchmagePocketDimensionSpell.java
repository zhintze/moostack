...
@AutoSpellConfig
public class ArchmagePocketDimensionSpell extends PocketDimensionSpell {
    ...
    public ArchmagePocketDimensionSpell() {
    ...
    public ResourceLocation getSpellResource() {
        return ResourceLocation.fromNamespaceAndPath(mooStack.MODID, "archmage_pocket_dimension");
    }
}
