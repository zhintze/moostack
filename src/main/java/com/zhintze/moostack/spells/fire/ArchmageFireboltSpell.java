...
@AutoSpellConfig
public class ArchmageFireboltSpell extends FireboltSpell {
    ...
    public ResourceLocation getSpellResource() {
        return ResourceLocation.fromNamespaceAndPath(mooStack.MODID, "archmage_firebolt");
    }
}
