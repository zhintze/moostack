...
@AutoSpellConfig
public class ArchmageSacrificeSpell extends SacrificeSpell {
    ...
    public ResourceLocation getSpellResource() {
        return ResourceLocation.fromNamespaceAndPath(mooStack.MODID, "archmage_sacrifice");
    }
}
