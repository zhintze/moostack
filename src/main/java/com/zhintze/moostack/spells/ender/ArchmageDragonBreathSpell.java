...
@AutoSpellConfig
public class ArchmageDragonBreathSpell extends DragonBreathSpell {
    ...
    public ArchmageDragonBreathSpell() {
    ...
    public ResourceLocation getSpellResource() {
        return ResourceLocation.fromNamespaceAndPath(mooStack.MODID, "archmage_dragon_breath");
    }
}
